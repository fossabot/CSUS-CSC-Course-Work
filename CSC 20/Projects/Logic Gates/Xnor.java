...
/**The "XNOR" class determines if two inputs are true
 *or false through the use of two boolean values which 
 *simulate the "XNOR" logic gate.
 *
 * @author Marc Woodyard
 * @version April 16 2017
 */
public class Xnor implements GateOutput, GateInputDouble {
    ...
    public boolean output() {
        ...
        if (this.input1 == false && this.input2 == false || this.input1 == true && this.input2 == true)
            return true;
        return false;
    }
}
